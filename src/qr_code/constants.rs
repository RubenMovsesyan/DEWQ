...
pub const ALPHA_NUMERIC_H_MAX_CAPACITY: [usize; MAX_VERSION] = [
    ...
    587, 640, 672, 744, 779, 864, 910, 958, 1016, 1080, 1150, 1226, 1307, 1394, 1431, 1530, 1591,
    1658, 1774, 1852,
];

pub const NUMERIC_L_MAX_CAPACITY: [usize; MAX_VERSION] = [
    41, 77, 127, 187, 255, 322, 370, 461, 552, 652, 772, 883, 1022, 1101, 1250, 1408, 1548, 1725,
    1903, 2061, 2232, 2409, 2620, 2812, 3057, 3283, 3517, 3669, 3909, 4158, 4417, 4686, 4965, 5253,
    5529, 5836, 6153, 6479, 6743, 7089,
];
...
pub const NUMERIC_M_MAX_CAPACITY: [usize; MAX_VERSION] = [
    ...
    1500, 1600, 1708, 1872, 2059, 2188, 2395, 2544, 2701, 2857, 3035, 3289, 3486, 3693, 3909, 4134,
    4343, 4588, 4775, 5039, 5313, 5596,
];

pub const NUMERIC_Q_MAX_CAPACITY: [usize; MAX_VERSION] = [
    27, 48, 77, 111, 144, 178, 207, 259, 312, 364, 427, 489, 580, 621, 703, 775, 876, 948, 1063,
    1159, 1224, 1358, 1468, 1588, 1718, 1804, 1933, 2085, 2181, 2358, 2473, 2670, 2805, 2949, 3081,
...
pub const NUMERIC_H_MAX_CAPACITY: [usize; MAX_VERSION] = [
    ...
    969, 1056, 1108, 1228, 1286, 1425, 1501, 1581, 1677, 1782, 1897, 2022, 2157, 2301, 2361, 2524,
    2625, 2735, 2927, 3057,
];

pub const BYTE_L_MAX_CAPACITY: [usize; MAX_VERSION] = [
...
pub const BYTE_M_MAX_CAPACITY: [usize; MAX_VERSION] = [
...
pub const BYTE_Q_MAX_CAPACITY: [usize; MAX_VERSION] = [
...
pub const BYTE_H_MAX_CAPACITY: [usize; MAX_VERSION] = [
...
pub const NUM_ERROR_CORRECTION_BLOCKS_GROUP_1_M: [usize; MAX_VERSION] = [
    1, 1, 1, 2, 2, 4, 4, 2, 3, 4, 1, 6, 8, 4, 5, 7, 10, 9, 3, 3, 17, 17, 4, 6, 8, 19, 22, 3, 21,
    19, 2, 10, 14, 14, 12, 6, 29, 13, 40, 18,
];
...
pub const NUM_ERROR_CORRECTION_BLOCKS_GROUP_2_M: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 0, 0, 0, 2, 2, 1, 4, 2, 1, 5, 5, 3, 1, 4, 11, 13, 0, 0, 14, 14, 13, 4, 3, 23, 7,
    10, 29, 23, 21, 23, 26, 34, 14, 32, 7, 31,
];
...
pub const NUM_ERROR_CORRECTION_BLOCKS_GROUP_2_H: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 2, 0, 1, 2, 4, 2, 8, 4, 4, 5, 7, 13, 17, 19, 16, 10, 6, 0, 14, 2, 13, 4, 28, 31,
    26, 25, 28, 35, 46, 1, 41, 64, 46, 32, 67, 61,
];
...
pub const NUM_CODE_WORDS_PER_BLOCK_GROUP_2_L: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 0, 0, 0, 0, 0, 69, 0, 93, 0, 116, 88, 99, 108, 121, 114, 108, 117, 112, 122, 118,
    107, 115, 123, 118, 117, 116, 116, 0, 116, 116, 122, 122, 123, 123, 118, 119,
];

pub const NUM_CODE_WORDS_PER_BLOCK_GROUP_2_M: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 0, 0, 0, 39, 37, 44, 51, 37, 38, 41, 42, 46, 47, 44, 45, 42, 0, 0, 48, 46, 48, 47,
    46, 46, 46, 48, 47, 47, 47, 47, 48, 48, 47, 47, 48, 48,
];

pub const NUM_CODE_WORDS_PER_BLOCK_GROUP_2_Q: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 16, 0, 15, 19, 17, 20, 23, 21, 21, 17, 25, 20, 23, 23, 22, 25, 23, 25, 25, 25, 25,
    23, 24, 25, 24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25,
];

pub const NUM_CODE_WORDS_PER_BLOCK_GROUP_2_H: [usize; MAX_VERSION] = [
    0, 0, 0, 0, 12, 0, 14, 15, 13, 16, 13, 15, 12, 13, 13, 16, 15, 15, 14, 16, 17, 0, 16, 17, 16,
